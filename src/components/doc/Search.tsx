...
const Search = () => {
  ...
  return (
    <div ref={dropdownRef} className="relative w-full lg:mt-16 mt-10">
      ...
      />
      {isDropdown && (
        <div className="lg:w-[70%] md:w-[90%] w-full lg:h-[220px] h-[180px] absolute z-30 top-16 flex flex-col space-y-2 rounded-lg p-4 bg-dark border border-glass overflow-auto">
